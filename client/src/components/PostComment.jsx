...
export const PostComment = memo(
  ({ postComment, onLike, onEdit, onDeleteComment }) => {
    ...
    const saveEditedContent = async () => {
      ...
      try {
        ...
        if (res.ok) {
          setIsEditing(false)
          dispatch(
            updateCommentSuccess({ ...postComment, content: newContent })
          )
                  ...
                  (currentUser._id === postComment.userId ||
                    ...
                    <>
                      ...
                      <button
                        ...
                        onClick={() => onDeleteComment(postComment._id)}
                      >
                        Delete
                      </button>
                    </>
